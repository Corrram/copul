...
def main(num_iters=1_000_000):
    ...
    for i in range(1, num_iters + 1):
        ...
        if rho_min < xi_min - 1e-8:
            ...
            print(f"Iteration {i}: tau_min={tau_min:.4f}, xi_min={xi_min:.4f}, rho_min={rho_min:.4f} for n={n}.")
            print(f"Matrix Min:\n{ccop_min.matr}")
            cis, cds = ccop_min.is_cis()
            print(f"CIS Min: {cis_min}, CDS Min: {cds_min}, LTD Min: {is_ltd_min}, PLOD Min: {is_plod_min}")
