...
def main():
    ...
    # Fill region
    ax.fill_between(beta_env, xi_env_lower, xi_env_upper, color=FILL_ENV, alpha=0.5, zorder=0)
    ...
    leg = ax.legend(handles, final_labels, loc="upper left", framealpha=0.9, edgecolor="none")
    ax.add_artist(leg)
