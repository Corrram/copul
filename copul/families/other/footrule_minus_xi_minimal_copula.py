...
if __name__ == "__main__":
    ...
    copula_endpoint = XiPsiLowerBoundaryCopula(mu=1.5)
    copula_endpoint.plot_cdf()
    copula_endpoint.plot_pdf()
    copula_endpoint.plot_cond_distr_1()
    copula_endpoint.plot_cond_distr_2()